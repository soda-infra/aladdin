import { filterByName, toIstioItems } from '../../../types/IstioConfigList';
import * as IstioConfigListFilters from '../FiltersAndSorts';
var mockIstioConfigList = function (names) {
    var testData = {
        namespace: {
            name: 'test'
        },
...
var unfiltered = mockIstioConfigList(['white', 'red', 'blue']);
describe('IstioConfigListContainer#filterByName', function () {
    it('should filter IstioConfigList by name', function () {
        var filtered = filterByName(unfiltered, ['white', 'red']);
...
describe('IstioConfigListContainer#toIstioItems', function () {
    it('should convert IstioConfigList in IstioConfigItems', function () {
        var istioItems = toIstioItems(unfiltered);
...
describe('IstioConfigComponent#sortIstioItems', function () {
    it('should sort IstioConfigItems by Istio Name', function () {
        var istioItems = toIstioItems(unfiltered);
        var sortField = IstioConfigListFilters.sortFields[2];
        var isAscending = true;
        return IstioConfigListFilters.sortIstioItems(istioItems, sortField, isAscending).then(function (sorted) {
    ...
    it('should sort DESC IstioConfigItems by Istio Name', function () {
        var istioItems = toIstioItems(unfiltered);
        var sortField = IstioConfigListFilters.sortFields[2];
    ...
    it('should sort IstioConfigItems by Istio Type', function () {
        var istioItems = toIstioItems(unfiltered);
        var sortField = IstioConfigListFilters.sortFields[1];
        var isAscending = true;
        return IstioConfigListFilters.sortIstioItems(istioItems, sortField, isAscending).then(function (sorted) {
            expect(sorted).toBeDefined();
            expect(sorted.length).toBe(45);
    ...
    it('should sort DESC IstioConfigItems by Istio Type', function () {
        var istioItems = toIstioItems(unfiltered);
        var sortField = IstioConfigListFilters.sortFields[1];
        var isAscending = false;
        return IstioConfigListFilters.sortIstioItems(istioItems, sortField, isAscending).then(function (sorted) {
...
//# sourceMappingURL=IstioConfigListComponent.test.js.map