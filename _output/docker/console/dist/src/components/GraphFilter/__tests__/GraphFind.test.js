...
var testSetter = function (_val) {
    console.log('set');
};
// TODO Find out why typescript is unhappy and get rid of all of these ts-ignores
describe('Parse find value test', function () {
    it('should return the correct selector for raw find values', function () {
        var wrapper = shallow(React.createElement(GraphFind, { cyData: { updateTimestamp: 123, cyRef: 'dummyRef' }, findValue: "testFind", hideValue: "testHide", showFindHelp: false, setFindValue: testSetter, setHideValue: testSetter, toggleFindHelp: testHandler }));
...
//# sourceMappingURL=GraphFind.test.js.map