...
var GraphHelpTour = [
    ...
    },
    {
        ...
        name: 'Edge Labels',
        description: 'Select the information to show on the edges between nodes. Response times reflect the 95th percentile.'
    },
    {
        offset: 0,
    ...
    },
    {
        ...
        name: 'Graph',
        description: "Single click a node to see its summary and emphasize its end-to-end paths.  Double click a node to see a graph focused on that node.\nDouble click an 'external namespace' node to navigate directly to the namespace in the node's text label."
    },
    {
        offset: 0,
...
//# sourceMappingURL=GraphHelpTour.js.map