...
describe('#ServiceInfoPodsGrouping', function () {
    it('should group pods of same reference', function () {
        var groups = groupPods(pods);
...
//# sourceMappingURL=ServiceInfoPodsGrouping.test.js.map