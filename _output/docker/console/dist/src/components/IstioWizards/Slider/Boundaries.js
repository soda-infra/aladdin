...
var Boundaries = function (props) {
    var children = props.children, min = props.min, max = props.max, reversed = props.reversed, showBoundaries = props.showBoundaries, slider = props.slider;
    var minElement = React.createElement("b", null, min);
    var maxElement = React.createElement("b", null, max);
    ...
    return (React.createElement("div", { className: "slider-pf" },
        leftBoundary,
        slider,
        rightBoundary,
        children));
