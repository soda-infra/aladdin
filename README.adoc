...
[link=https://github.com/soda-infra/aladdin/blob/master/img/aladdin-Infrastructure.png]
image::img/aladdin-infrastructure.png[Aladdin Infrastructure, width=800]
